...
cron.schedule('* * * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, fetchUsers_1.default)()];
            case 2:
                _a.sent(); // Fetch and save users
                console.log("[CRON] Job completed successfully at ".concat(new Date().toISOString()));
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error("[CRON] Job failed at ".concat(new Date().toISOString(), ":"), error_1);
                return [3 /*break*/, 4];
